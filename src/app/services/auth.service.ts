...
export class AuthService {
  ...
  register ( name: String, email: String, password: String, c_password: string, phone_number: String ) {
    return this.http.post( this.env.API_URL + 'register',
      { name: name, email: email, password: password, c_password: c_password, phone_number: phone_number }
    )
  }
  logout () {
